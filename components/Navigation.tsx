    ...
    return (
        <nav>
            <div className="flex py-6 px-4 w-[65%] mx-auto">
                <img src="/union-jack.png" alt="UK Data Atlas Logo" className="h-[24px] opacity-100 rounded grayscale-100 mr-3 content-center mt-[2px] transform scale-x-[-1] hover:grayscale-0 transition-all duration-1000 cursor-pointer" />
