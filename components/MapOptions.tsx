        ...
        <div className="bg-[rgba(255,255,255,0.5)] text-sm rounded-md backdrop-blur-md shadow-lg border border-white/30">
            <div className="p-2.5">
                ...
                <div className="flex items-center justify-between gap-2">
                    <div className="flex flex-col border border-white/20 rounded-sm overflow-hidden bg-white/10 backdrop-blur-md shadow-sm">
                    ...
                    <button className="border border-white/20 rounded-sm px-2 py-0.5 text-xs bg-white/10 backdrop-blur-md hover:bg-white/20 transition-all duration-200 shadow-sm hover:shadow-md text-gray-500 font-medium cursor-pointer">
                        Export
                    </button>
                </div>
            </div>
