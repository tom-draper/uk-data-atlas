...
export default function PopulationChart({
	...
	let males = populationStats?.males || 0;
	let females = populationStats?.females || 0;
	let ageGroups = populationStats?.ageGroups || { total: { '0-17': 0, '18-29': 0, '30-44': 0, '45-64': 0, '65+': 0 } };
