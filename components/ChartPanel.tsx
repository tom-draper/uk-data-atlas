...
const GeneralElectionResultChartSection = dynamic(() => import("./elections/general/GeneralElectionResultChartSection"), { ssr: false });
const LocalElectionResultChartSection = dynamic(() => import("./elections/local/LocalElectionResultChartSection"), { ssr: false });
const BrexitSection = dynamic(() => import("./elections/referendum/BrexitSection"), { ssr: false });
const DemographicsChartSection = dynamic(() => import("./demographics/DemographicsChartSection"), { ssr: false });
const EconomicsSection = dynamic(() => import("./economics/EconomicsSection"), { ssr: false });
const DeprivationSection = dynamic(() => import("./deprivation/DeprivationSection"), { ssr: false });
const HealthSection = dynamic(() => import("./health/HealthSection"), { ssr: false });
const EducationSection = dynamic(() => import("./education/EducationSection"), { ssr: false });
const TelecomsSection = dynamic(() => import("./telecoms/TelecomsSection"), { ssr: false });
const EnvironmentSection = dynamic(() => import("./environment/EnvironmentSection"), { ssr: false });
const CustomSection = dynamic(() => import("./custom/CustomSection"), { ssr: false });
