	...
	return (
		...
		>
			...
			<div className="relative z-10 flex items-start justify-between mb-1.5 shrink-0">
				<h3 className={chartHeadingClass(isDark)}>Temporary Accommodation [{dataset.quarter}]</h3>
				<span className={`text-[9px] ${isDark ? "text-gray-500" : "text-gray-400"}`}>England</span>
			</div>
			...
			{!hasData ? (
				...
				<div className="flex-1 flex flex-col gap-1">
					<div className="flex items-baseline justify-between">
						...
						<span className={`text-[9px] ${isDark ? "text-gray-500" : "text-gray-400"}`}>{stats!.householdsInTemporaryAccommodation.toLocaleString()} households</span>
					</div>
