...
export type Geography = { type: string; boundaryYear: number };
...
export const areaCodeSets = new WeakMap<AreaReleaseArtifact, Set<string>>();

export const areaCodesOf = (artifact: AreaReleaseArtifact) => {
...
export const TOTAL_TOLERANCE = 1e-9;
