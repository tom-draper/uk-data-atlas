...
export const handleRelationshipCoverageRoutes = ({ context, releaseId, parsedUrl, segments }: RouteRequest): ApiResponse | undefined => {
	...
	if (!context.geographyResolver) return problem(503, "Catalogue Unavailable", "Build the area identity and relationship artifacts before reporting relationship coverage.");
