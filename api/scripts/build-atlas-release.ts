...
export const buildAtlasRelease = (
	...
	const release = createAtlasRelease(outputDirectory, generatedAt);
...
if (process.argv[1] && resolve(process.argv[1]) === scriptPath) {
	...
	console.log(`Wrote atlas release ${result.releaseId} to ${result.releasePath}`);
}
