...
export type CatalogueDatasetType = "airQuality" | "brexit" | "brexitConstituency" | "broadband" | "childPoverty" | "claimantCount" | "crime" | "ethnicity" | "fuelPoverty" | "generalElection" | "homelessness" | "housePrice" | "imd" | "income" | "lifeExpectancy" | "localElection" | "nhsWaiting" | "nimdm" | "population" | "qualification" | "schoolPerformance" | "simd" | "unemployment" | "wimd";
export type CatalogueDataset = AirQualityDataset | BrexitLADDataset | BrexitConstituencyDataset | BroadbandDataset | ChildPovertyDataset | ClaimantCountDataset | CrimeDataset | EthnicityDataset | FuelPovertyDataset | GeneralElectionDataset | HomelessnessDataset | HousePriceDataset | IMDDataset | IncomeDataset | LifeExpectancyDataset | LocalElectionDataset | NHSWaitingDataset | NIMDMDataset | PopulationDataset | QualificationDataset | SchoolPerformanceDataset | SIMDDataset | UnemploymentDataset | WIMDDataset;
