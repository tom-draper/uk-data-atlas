...
export const KNOWN_PARTIES_2024 = ['Con', 'Lab', 'LD', 'RUK', 'Green', 'SNP', 'PC', 'DUP', 'SF', 'SDLP', 'UUP', 'APNI'];
export const KNOWN_PARTIES_PRE_2024 = ['Con', 'Lab', 'LD', 'BRX', 'Green', 'SNP', 'PC', 'DUP', 'SF', 'SDLP', 'UUP', 'APNI', 'UKIP'];
