...
const themeDefinitions = [
	...
	{ id: "brownteal" as ColorTheme, label: "Brown-Teal", colors: ["#8c510a", "#d8b365", "#f5f5f5", "#5ab4ac", "#01665e"] },
	{ id: "purpleorange" as ColorTheme, label: "Purple-Orange", colors: ["#7b3294", "#c2a5cf", "#f7f7f7", "#fdb863", "#e66101"] },
	{ id: "pinkgreen" as ColorTheme, label: "Pink-Green", colors: ["#c51b7d", "#e9a3c9", "#f7f7f7", "#a1d76a", "#4d9221"] },
	{ id: "ylorrd" as ColorTheme, label: "Yellow-Orange-Red", colors: ["#ffffb2", "#fecc5c", "#fd8d3c", "#f03b20", "#bd0026"] },
	{ id: "purplered" as ColorTheme, label: "Purple-Red", colors: ["#f1eef6", "#d4b9da", "#c994c7", "#df65b0", "#dd1c77", "#980043"] },
	{ id: "turbo" as ColorTheme, label: "Turbo", colors: ["#30123b", "#4662d7", "#35aaf8", "#1ae4b6", "#72fe5e", "#c8ef34", "#faba39", "#f66b19", "#ca2a04", "#7a0403"] },
	{ id: "coolwarm" as ColorTheme, label: "Cool-Warm", colors: ["#3b4cc0", "#6788ee", "#aabcfd", "#f7f7f7", "#f7a789", "#e26952", "#b40426"] },
	{ id: "spectral" as ColorTheme, label: "Spectral", colors: ["#9e0142", "#d53e4f", "#f46d43", "#fdae61", "#fee08b", "#e6f598", "#abdda4", "#66c2a5", "#3288bd", "#5e4fa2"] },
	{ id: "ylgnbu" as ColorTheme, label: "Yellow-Green-Blue", colors: ["#ffffd9", "#c7e9b4", "#7fcdbb", "#41b6c4", "#1d91c0", "#225ea8", "#0c2c84"] },
];
