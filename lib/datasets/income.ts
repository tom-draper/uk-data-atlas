...
export const incomeDefinition: ChartDatasetDefinition<IncomeDataset> = {
	...
	chart: { group: "Economics", key: "economics-income", label: "Income [2025]", defaultVisible: true, componentPath: "@/components/economics/income/IncomeChart", calculateStats: (m, g, d, l, id) => m.calculateIncomeStats(g, d, l, id), year: 2025 },
