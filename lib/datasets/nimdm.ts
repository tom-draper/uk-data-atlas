...
export const nimdmDefinition: ChartDatasetDefinition<NIMDMDataset> = {
	...
	chart: { group: "Deprivation", key: "deprivation-nimdm", label: "Deprivation (NIMDM) [2017]", defaultVisible: false, componentPath: "@/components/deprivation/nimdm/NIMDMChart", calculateStats: (mm, g, d, l, id) => mm.calculateNIMDMStats(g, d, l, id), year: 2017 },
