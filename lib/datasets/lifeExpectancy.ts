...
export const lifeExpectancyDefinition: ScalarDatasetDefinition<LifeExpectancyDataset> = {
	...
	map: { valueFor: () => null, colorRange: { min: 72, max: 84 }, legend: { min: 72, max: 84, format: String } },
