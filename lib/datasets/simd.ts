...
export const simdDefinition: ChartDatasetDefinition<SIMDDataset> = {
	...
	chart: { group: "Deprivation", key: "deprivation-simd", label: "Deprivation (SIMD) [2020]", defaultVisible: false, componentPath: "@/components/deprivation/simd/SIMDChart", calculateStats: (mm, g, d, l, id) => mm.calculateSIMDStats(g, d, l, id), year: 2020 },
