            ...
            <div className="fixed inset-0 z-100 h-full w-full pointer-events-none">
                ...
                <div className="absolute left-0 flex h-full">
                    <div className="pointer-events-auto p-[10px]">
                        <div className="bg-[rgba(255,255,255,0.8)] text-sm rounded-md backdrop-blur-md shadow-lg w-[200px] h-[100%]">
                            <div className="p-[10px]">
                                <h2 className="font-semibold">Greater Manchester</h2>
                                <div>{15000} people</div>
                            </div>

                            <div className="p-[10px]">
                                <h2 className="font-semibold">Merseyside</h2>
                                <div>{15000} people</div>
                            </div>
