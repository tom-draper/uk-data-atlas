...
export default function AreasPage() {
	return (
		...
		>
			...
			/>
			<P>
				[List geographies](/docs/reference/geography/list-geographies)
			...
			<Callout tone="tip">
				...
				date](/docs/reference/geography/resolve-boundary-release-for-date)
				picks the right one.
			</Callout>
			...
			<P>
				...
				fit](/docs/reference/data-catalogue/measure-compatibility) lists
				the releases that work.
			</P>
