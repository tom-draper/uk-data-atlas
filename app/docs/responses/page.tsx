...
const ENVELOPE = `{
  "apiVersion": "v1",
  "atlasRelease": "sha256:5c4aa4529cbfbd5e4c844c55cddba1ef04a7bf76f3eaa085a357fff401af6d0c",
  "data": {
		...
		>
			...
			<Table
				...
				rows={[
					...
					[
						"`atlasRelease`",
						"The [Atlas release](/docs/concepts/releases) that produced this response.",
					],
					[
						"`meta.nextCursor`",
						"The cursor for the next page, or `null` if this is the last. See [Pagination](/docs/pagination).",
					],
					[
						"`apiVersion`",
			...
			<P>
				...
				dataset downloads](/docs/reference/sync/download-bulk-export),
				[lookup tables](/docs/reference/sync/download-bulk-lookup),
				[vector tiles](/docs/reference/geography/map-resource-tile), the
				[tile archive](/docs/reference/geography/map-resource-archive)
				and the [OpenAPI
				spec](/docs/reference/start-here/openapi-description). Each says
				so on its reference page.
			</P>
			<P>
				Errors are never wrapped in the envelope either. They have a
				shape of their own, described in [Errors](/docs/errors).
			</P>
		</DocPage>
	);
}
