...
const legacyDatasets: DatasetSource[] = [
	...
	},
	{
		...
		licenceUrl:
			"http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/",
		description:
			"How far non-disadvantaged pupils are ahead of disadvantaged pupils at Key Stage 4, by local authority district for England. A derived difference in Attainment 8, not the Department's rank-based disadvantage gap index.",
	},
	{
		name: "Air Quality",
